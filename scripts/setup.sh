...
show_usage() {
    ...
    echo "                 Use --force to reinstall even if already configured"
    echo "                 Use --wg-conf <path> for WireGuard backhaul from a .conf"
    ...
    echo "                 Use --wg-backhaul/--wg-conf/--vless-backhaul to switch backhaul,"
    echo "                 --wg-lan-allow to tune the WG LAN-exception list"
